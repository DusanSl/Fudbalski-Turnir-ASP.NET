...
            /// </summary>
            [Required]
            [StringLength(7, ErrorMessage = "{0} mora biti dugačak najmanje {2} i najviše {1} karaktera.", MinimumLength = 6)]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("Korisnik sa ID-jem '{UserId}' je omogućio 2FA pomoću aplikacije za autentifikaciju.", userId);

            StatusMessage = "Vaša aplikacija za autentifikaciju je verifikovana.";
        ...
        {
            // Učitaj ključ autentifikatora i QR kod URI za prikaz na formi
