...
namespace Fudbalski_turnir.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required(ErrorMessage = "Polje '{0}' je obavezno.")]
            [StringLength(100, ErrorMessage = "{0} mora biti dugačka barem {2} i najviše {1} karaktera.", MinimumLength = 6)]
            [DataType(DataType.Password)]
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("Korisnik je uspešno promenio lozinku.");
            StatusMessage = "Vaša lozinka je promenjena.";
